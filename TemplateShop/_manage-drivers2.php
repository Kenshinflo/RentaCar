    ...
    <div class="modal-content">
	  ...
	  <form action="../insert-functions.php" method="POST" enctype="multipart/form-data">
	  		...
	  		<div class="form-group">
				<label>Name</label>
				<input type="text" class="form-control" autocomplete="off" name="driver_name2" id="driver_name2" value="<?php echo $name; ?>" required>
			</div>

			<div class="form-group">
				<label>Age</label>
				<input type="text" class="form-control" autocomplete="off" name="driver_age2" id="driver_age2" value="<?php echo $age; ?>" required>
			</div>

			<div class="form-group">
				<label>Contact Number</label>
				<input type="text" class="form-control" autocomplete="off" name="driver_contact2" id="driver_contact2" value="<?php echo $contact; ?>" required>
			</div>

			<div class="form-group">
				<label>Address</label>
				<input type="text" class="form-control" autocomplete="off" name="driver_address2" id="driver_address2" value="<?php echo $address; ?>" required>
			</div>
