...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <button onclick="window.location='_driver-register.php';" id="seller-login account" type="submit" class="btnadd btn-primary" name="submit">Add Driver</button>
                <div class="row my-5">
                                    ...
                                    <td> 
                                        <form action="_update-driver.php"  class="d-inline">
                                         ...
                                         <form action="insert.php" method="POST" class="d-inline">
                                            <button type="submit" name="removeDriver" value="<?=$row['driver_id'];?>" class="btn btn-danger btn-sm">Delete</button>
                                         </form>
                                    </td>
