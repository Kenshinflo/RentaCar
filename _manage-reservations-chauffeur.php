...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <button onclick="window.location='_manage-reservations.php';" id="seller-login account" type="submit" class="btnadd btn-primary" name="submit">No Driver</button>
                <div class="row my-5">
                    ...
                    <div class="col">
                        <table class="table bg-white rounded shadow-sm table-hover">
                            ...
                            $sql = "SELECT * FROM reservation WHERE driver_stat='Yes' AND seller_id = {$com_id}";
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <form action="_update-reservation-chauffer.php" class="d-inline">
